...
from core.forms.frame_type import FrameTypeCreationForm,FrameTypeChangeForm
...
class FrameTypeListView(MyListView):
    ...
    template_name = "core/frame_type/frame_type_list.html"
    permission_required = ("core.view_frametype",)
...
class FrameTypeCreateView(MyCreateView):
    ...
    template_name = "core/frame_type/frame_type_form.html"
    permission_required = ("core.add_frametype",)
...
class FrameTypeUpdateView(MyUpdateView):
    ...
    template_name = "core/frame_type/frame_type_form.html"
    permission_required = ("core.change_frametype",)
...
class FrameTypeDeleteView(MyDeleteView):
    ...
    permission_required = ("core.delete_frametype",)
