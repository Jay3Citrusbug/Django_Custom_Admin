...
from core.forms.model_year import ModelYearCreationForm,ModelYearChangeForm
...
class ModelYearListView(MyListView):
    """
    View for ModelYear listing
    """
    # paginate_by = 25
    ordering = ["-id"]
    model = ModelYear
    queryset = model.objects.all()
    template_name = "core/model_year/model_year_list.html"
    permission_required = ("core.view_modelyear",)



class ModelYearCreateView(MyCreateView):
    """
    View to create ModelYear
    """
    model = ModelYear
    form_class = ModelYearCreationForm
    template_name = "core/model_year/model_year_form.html"
    permission_required = ("core.add_modelyear",)
...
class ModelYearUpdateView(MyUpdateView):
    """
    View to update ModelYear
    """

    model = ModelYear
    form_class = ModelYearChangeForm
    template_name = "core\model_year\model_year_form.html"
    permission_required = ("core.change_modelyear",)

    def get_success_url(self):
        return reverse("core:modelyear-list")


class ModelYearDeleteView(MyDeleteView):
    """
    View to delete ModelYear
    """
    model = ModelYear
    template_name = "core/confirm_delete.html"
    permission_required = ("core.delete_modelyear",)

    def get_success_url(self):
        return reverse("core:modelyear-list")


class ModelYearAjaxPagination(DataTableMixin, HasPermissionsMixin, MyLoginRequiredView):
    """
    Ajax-Pagination view for ModelYear
    """
    model = ModelYear
