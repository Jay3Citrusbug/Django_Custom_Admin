...
urlpatterns = [
	...
	path('dashboard-integration/shops-carrying/', views.shops_carrying, name='shops_carrying'),
	...
	path('search/', views.search, name='search-reviews'),
	...
	path('comment/upvote', views.comment_upvote, name='comment_upvote'),
